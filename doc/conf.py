...
project = u"sage-euler-product sage package"

package_name = 'euler_product'
package_folder = "../../euler_product"
authors = u"..."
...
sys.path.append(os.path.abspath('../../euler_product'))
